app.controller('contactTreeCtrl', ['$scope', '$http', '$timeout', '$rootScope','$state', function($scope, $http, $timeout, $rootScope,$state) {
    ...
    $scope.org_select_load = function(branch){
    	$state.go('app.cam.organdstaff',{orgUnitId:branch.id});
    };
    //加载行政树
