...
app.controller('OrgSearchCtrl', ['$scope', '$http', '$timeout', '$modal', 'OrgSearch', 'DataService', '$rootScope', 
	function($scope, $http, $timeout, $modal, OrgSearch, DataService, $rootScope) {
		var entity = $scope.entity = {};
		var options = $scope.options = {
			search: false,
			showDetail: false
...
app.controller('StaffInfoCtrl', ['$scope', '$stateParams', '$http', '$modalInstance',  'modalParams', '$modal', 
 	function($scope, $stateParams, $http, $modalInstance, modalParams, $modal){
...
console.log(staff);
 		...
 		$scope.removeCollection = function(staff, strType) {
 			console.log(staff);
 		};
