    ...
    angular.module('ngTable').controller('ngTableController', ['$scope', 'NgTableParams', '$timeout', '$parse', '$compile', '$attrs', '$element',
        ...
        function($scope, NgTableParams, $timeout, $parse, $compile, $attrs, $element, ngTableColumn, ngTableEventsChannel) {
            ...
            this.compileDirectiveTemplates = function () {
                ...
                tr.after('<tr><td>11111111111111</td></tr>');
                if (!$element.hasClass('ng-table')) {
                    ...
                    var noDataShow = angular.element(document.createElement('tr')).attr('ng-include', "'ng-table/noDataShow.html'");
                    $element.find('tbody').find('tr').after(noDataShow);
                    $compile(noDataShow)($scope);
                }
            };
...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put('ng-table/noDataShow.html', '<tr>{{params.data | json}}111</tr><tr ng-if="params.data.length == 0"><td>111111111111111111</td></tr>');
}]);
